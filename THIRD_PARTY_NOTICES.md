...
It depends on third-party packages distributed under their own licenses.
Redistributing this project may require complying with dependency licenses.
Review the licenses of the dependencies listed below before distribution.
...
- This file lists only the **direct** dependencies declared in `package.json`.
- Transitive dependencies may have additional license obligations.
- Generate a dependency license report for stricter redistribution checks.
- Keep the report updated with a license-checker tool or similar automation.
